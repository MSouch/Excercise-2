...
const Dashboard=()=> {
  ...
  const challenges=[
    {
      id: 1,
      title: 'Challenge 1: Integrated Work Package Risk Planning',
      description: 'Systematic risk assessment and control integration for maintenance planning',
      path: '/challenge/1'
    },
    {
      id: 2,
  title: 'Challenge 2: Turnaround Critical Path Risk Management',
      description: 'Contingency planning and decision frameworks for turnaround risks',
      path: '/challenge/2'
    },
    {
      id: 3,
  title: 'Challenge 3: Capital Project Interface Risk Coordination',
      description: 'Interface risk management and coordination protocols for complex projects',
      path: '/challenge/3'
    },
    {
      id: 4,
  title: 'Challenge 4: Continuous Risk Learning Integration',
      description: 'Sustainable risk management systems with feedback loops and capability development',
      path: '/challenge/4'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600">
            Complete challenges in sequence to unlock the next level and master systematic risk management
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-success-100">
                        <Link
                          to="/conclusion"
                          onClick={(e)=> { e.preventDefault(); navigate('/conclusion') }}
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              transition={{delay: 0.3,duration: 0.5}}
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Risk Management Challenges</h2>
              <p className="text-gray-600">
                Complete each challenge in order. You must finish Challenge {progress.completedChallenges + 1 || 1} to unlock the next one.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-2 text-sm text-primary-700">
                <p>• Complete challenges in order - each builds on systematic risk management principles</p>
                ...
                {progress.completedChallenges===4 && (
                  <p className="font-semibold text-success-700">• All challenges complete - generate your Risk Navigator Expert certificate!</p>
                )}
              </div>
            </motion.div>
          </div>
