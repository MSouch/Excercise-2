export const challengeContent = {
  ...
  guidingQuestion: "How do the risk identification methods from Lesson 1 apply to this maintenance planning situation? What specific risk categories should you systematically evaluate?",
  ...
  explanation: "Comprehensive risk identification (Lesson 1) systematically evaluates safety, operational, equipment, and resource risks. Maintenance-specific integration (Lesson 2) addresses equipment-specific risk factors and operational constraints. Embedded risk controls (Lesson 5) places risk management directly within execution procedures while incorporating lessons from previous failures."
      },
      C: {
        correct: false,
  message: "Risk management is a line responsibility that must be integrated by planners, not delegated to separate departments. Lesson 5 emphasizes that planners are uniquely positioned to embed risk controls where they can be most effective - in the work packages themselves.",
  guidingQuestion: "What is your specific role as a planner in risk management according to Lesson 5? How do you embed risk management directly into planning deliverables?",
      ...
      D: {
        correct: false,
  message: "Previous work packages that resulted in failures indicate inadequate risk management that will likely repeat without systematic improvement. Lesson 2 emphasizes learning from maintenance experience to enhance future planning.",
  guidingQuestion: "What can the previous failure teach you about risk factors that weren't properly addressed? How should maintenance-specific risk considerations from Lesson 2 inform your new approach?",
  ...
  title: "Turnaround Critical Path Risk Management",
    ...
    feedback: {
      A: {
        correct: false,
  message: "Proceeding without contingency planning for known risks violates fundamental turnaround risk management principles. Lesson 3 emphasizes that schedule pressures require proactive risk management, not risk denial.",
  guidingQuestion: "How do the schedule risk analysis principles from Lesson 3 apply when you have advance warning of potential critical path impacts?",
      ...
      B: {
        correct: false,
  message: "Automatically extending schedules for potential risks without analysis creates unnecessary costs and may not address the actual risk effectively. Lesson 3 teaches risk response selection based on probability and impact assessment.",
  guidingQuestion: "What risk response strategies from Lesson 3 allow you to address risks without automatically accepting the highest cost option?",
  ...
  explanation: "Proactive contingency planning (Lesson 3) develops resource and schedule alternatives before they're needed. Risk response optimization uses mitigation strategies to address risks without accepting worst-case outcomes. Decision point management establishes clear trigger points for contingency activation while maintaining stakeholder confidence through systematic planning."
      },
      D: {
        correct: false,
  message: "Removing required inspection work creates safety and regulatory risks far greater than schedule risks. Lesson 3 emphasizes that risk response must consider all risk categories, not just schedule impacts.",
  guidingQuestion: "How do you balance different risk categories when managing complex turnaround risks? What does Lesson 3 teach about comprehensive risk response?",
  ...
  title: "Capital Project Interface Risk Coordination",
    ...
    feedback: {
      A: {
        correct: false,
  message: "Weekly meetings without systematic interface risk management create coordination theater that doesn't address underlying risk factors. Lesson 4 emphasizes that complex projects require structured interface management, not just communication.",
  guidingQuestion: "What specific interface risk management tools from Lesson 4 are needed to address complex multi-contractor coordination systematically?",
  ...
  explanation: "Comprehensive interface identification (Lesson 4) maps all organizational, technical, and operational interfaces systematically. Risk-based prioritization focuses resources on highest-risk interfaces while maintaining oversight. Integrated monitoring systems create visibility across project phases and contractor boundaries with proactive coordination protocols."
      },
      C: {
        correct: false,
  message: "Interface risks are interdependent - problems in secondary interfaces often cascade to affect critical interfaces. Lesson 4 teaches that interface management requires comprehensive coverage with risk-based prioritization.",
  guidingQuestion: "How do interface interdependencies in Lesson 4 create risks when secondary interfaces are not properly managed?",
      ...
      D: {
        correct: false,
  message: "Escalating operational interface issues to senior management creates bottlenecks and delays while removing problem-solving from the most knowledgeable level. Lesson 4 emphasizes that planners are uniquely positioned to coordinate technical interfaces.",
  guidingQuestion: "What is your specific role as a planner in capital project interface risk management according to Lesson 4? How can you coordinate interfaces systematically?",
  ...
  title: "Continuous Risk Learning Integration",
    ...
    feedback: {
      A: {
        correct: false,
  message: "Simply reducing procedures without systematic optimization can eliminate effective risk controls along with administrative burden. Lesson 5 emphasizes that mature risk management requires sophistication, not simplification.",
  guidingQuestion: "How do the continuous improvement principles from Lesson 5 help optimize risk management effectiveness rather than just reducing complexity?",
  ...
  explanation: "Systematic feedback integration (Lesson 5) captures lessons learned to drive continuous improvement. Performance measurement (Lesson 1) uses metrics to optimize risk management effectiveness. Capability development (Lesson 5) builds organizational risk management maturity over time while balancing effectiveness with sustainability through systematic improvement."
      },
      C: {
        correct: false,
  message: "Refusing to adapt based on feedback prevents organizational learning and can create resistance that undermines risk management effectiveness. Lesson 5 teaches that sustainable systems must evolve based on experience.",
  guidingQuestion: "What does Lesson 5 teach about balancing risk management rigor with practical sustainability? How do feedback systems improve effectiveness?",
      ...
      D: {
        correct: false,
  message: "Creating multiple separate systems increases complexity and prevents organizational learning across different work contexts. Lessons 1-5 teach that risk management principles are consistent while applications adapt to context.",
  guidingQuestion: "How do the integrated risk management principles from Lessons 1-5 create consistency while allowing contextual adaptation? What role do feedback systems play?",
