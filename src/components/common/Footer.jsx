        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li className="text-white font-medium">Risk Management Navigator</li>
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">
              ...
              {' '}<a href="mailto:support@ap-learningsystems.com" className="text-white underline hover:no-underline">support@ap-learningsystems.com</a>.
            </p>
          </div>
        </div>
